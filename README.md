...
| -------------------- |-------------| --------------|---------|--------------|
| [Final Project - Beloved Machine](https://github.com/MarkChanner/final-project) | Audio sequencer build in 9 days as a final project with three other amazing Makers students. | Javascript, Web Audio API, Canvas API, HTML, CSS, Istanbul, ESLint | Jasmine | <a href="https://stranger-synths.herokuapp.com/"><img src="logo/heroku.png" width="60" align="center"></a>
